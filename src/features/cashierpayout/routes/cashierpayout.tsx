...
export function Cashierpayout() {
  ...
  const debounceTime = 500; // Adjust debounce time as needed
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`${baseUrl}/business-payout-cashier-process/${selectedBizId}`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: token ? `Bearer ${token}` : "",
        ...
        <div className="mt-5 max-w-lg mx-auto p-6 bg-white dark:bg-neutral-800 rounded-lg shadow-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex flex-col">
              <label className="mb-1 font-medium text-gray-700 dark:text-neutral-200" htmlFor="account_number">
                Account Number
              </label>
              <input
                  type="text"
            ...
            {/* Account Name */}
            <div className="flex flex-col">
              <label className="mb-1 font-medium text-gray-700 dark:text-neutral-200" htmlFor="account_name">
                Account Name
              </label>
              <input
                  type="text"
            ...
            {/* Bank Code */}
            <div className="flex flex-col">
              <label className="mb-1 font-medium text-gray-700 dark:text-neutral-200" htmlFor="bank_code">
                Bank Code
              </label>
              <input
                  type="text"
            ...
            {/* Apply Cashback */}
            <div className="flex flex-col">
              <label className="mb-1 font-medium text-gray-700 dark:text-neutral-200" htmlFor="apply_cashback">
                Apply Cashback
              </label>
              <input
                  type="number"
                  name="apply_cashback"
                  value={formData.apply_cashback}
                  onChange={handleChange}
                  id="apply_cashback"
                  className="h-12 w-full rounded-lg border border-gray-300 bg-white p-3 outline-none dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-200"
