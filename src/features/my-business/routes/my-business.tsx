...
import { useMyBusiness } from "../api/useMyBusiness";
          ...
          <>
            ...
            <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-3">
              {content?.map((item, index) => (
                <div
                  key={index}
                  className="flex min-h-[350px] flex-col justify-between space-y-3 rounded-xl bg-white dark:bg-neutral-800 px-6 py-4"
                >
                  ...
                  <Link to={`${makeDashCase(item?.name)}-${item?.id}`}>
        ...
        <div className="flex flex-col gap-1">
          <div className="relative">
            <input
              ...
              className="h-12 w-full rounded-xl border bg-white dark:bg-neutral-800 dark:border-neutral-700 px-12 pr-20 text-sm outline-none focus:border-primary disabled:cursor-not-allowed"
