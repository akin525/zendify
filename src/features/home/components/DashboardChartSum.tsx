...
import { useDashboardChartSum } from "../api/getDashboard";
import { Chart } from "./Chart";
import { ChartData } from "../types";

export const DashboardChartSum = () => {
  const [time, setTime] = useState("Daily");
  const { data: chartSumData, isPending, error } = useDashboardChartSum();
  ...
  return (
    <div className="flex h-[400px] w-full flex-col gap-10 rounded-xl bg-white p-4 dark:border dark:border-neutral-700 dark:bg-neutral-800">
      <div className="flex items-center justify-between pb-5">
        <h3 className="text-sm font-semibold">Dashboard Chart Sum</h3>
